...
namespace dso
{
    ...
    public:
        ...
        virtual void computeError() override
        {
            ...
            Vec2 obs(_measurement);
            _error = obs - cam->cam_map(T_p_from_world->estimate() * T_anchor_from_world->estimate().inverse() * dso::invert_depth(psi->estimate()));
        }
        ...
        virtual void linearizeOplus() override
        {
            ...
            Vec3 x_a = dso::invert_depth(psi_a);
            Vec3 y = T_ca * x_a;
